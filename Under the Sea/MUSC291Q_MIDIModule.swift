...
class MUSC291Q_MIDIModule {
    ...
    //MARK: init routine
    /**
     Before using this class, you'll need to have created a single instance of an AVAudioEngine - this single instance should then be used for ALL instances of MUSC291Q_MIDIModule.
     
    If you do not wish to include a midi file, simply use "" for fileName and fileExt
     */
    init(mainEngine:AVAudioEngine, defaultPatch:UInt8?, defaultChannel:UInt8?, midiFileName:String?, midiFileExt:String?) {
        ...
        sequencer = AVAudioSequencer(audioEngine: mainEngine)
